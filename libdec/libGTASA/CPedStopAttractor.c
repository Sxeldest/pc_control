...
// Address: 0x4ac520
// Original: _ZNK17CPedStopAttractor7GetTypeEv
// Demangled: CPedStopAttractor::GetType(void)
int __fastcall CPedStopAttractor::GetType(CPedStopAttractor *this)
{
  return 2;
}
...
// Address: 0x4ac524
// Original: _ZN17CPedStopAttractorD0Ev
// Demangled: CPedStopAttractor::~CPedStopAttractor()
