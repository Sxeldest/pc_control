...
// Address: 0x4ac640
// Original: _ZNK26CPedTriggerScriptAttractor7GetTypeEv
// Demangled: CPedTriggerScriptAttractor::GetType(void)
int __fastcall CPedTriggerScriptAttractor::GetType(CPedTriggerScriptAttractor *this)
{
  return 5;
}
...
// Address: 0x4ac644
// Original: _ZN26CPedTriggerScriptAttractorD0Ev
// Demangled: CPedTriggerScriptAttractor::~CPedTriggerScriptAttractor()
