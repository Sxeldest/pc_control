...
// Address: 0x4ac758
// Original: _ZNK21CPedScriptedAttractor7GetTypeEv
// Demangled: CPedScriptedAttractor::GetType(void)
int __fastcall CPedScriptedAttractor::GetType(CPedScriptedAttractor *this)
{
  return 7;
}
...
// Address: 0x4ac75c
// Original: _ZN21CPedScriptedAttractorD0Ev
// Demangled: CPedScriptedAttractor::~CPedScriptedAttractor()
