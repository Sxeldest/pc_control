...
// Address: 0x18dae0
// Original: j__ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateTask(void)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateTask()
{
  return _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE10CreateTaskEv();
}
...
// Address: 0x193bf8
// Original: j__ZNK22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateSubTask(int,CPed *)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateSubTask()
{
  return _ZNK22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE13CreateSubTaskEiP4CPed();
}
...
// Address: 0x495360
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateTask(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateTask(int a1, int a2, int a3)
{
  char v3; // r4
  char *v4; // r1
  int v5; // r2
...
LABEL_18:
  ...
  v10 = 0;
LABEL_20:
  v11 = CTask::operator new((CTask *)&dword_50, (unsigned int)v4);
  ...
  *(_DWORD *)(v11 + 72) = 6;
  v12 = *(_BYTE *)(v11 + 76);
  *(_DWORD *)v11 = &off_6689F0;
  *(_DWORD *)(v11 + 64) = &off_66D3F4;
  *(_BYTE *)(v11 + 76) = v12 & 0xF0 | 3;
  *(_DWORD *)(v11 + 12) = v10;
  if ( v10 )
...
// Address: 0x49b3f0
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdED2Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
  CEntity **v3; // r1
...
// Address: 0x49b41c
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdED0Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
...
// Address: 0x49b44c
// Original: _ZNK22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE5CloneEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::Clone(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::Clone(int a1, unsigned int a2)
{
  int v3; // r5
  __int64 v4; // d8
  __int64 v5; // d9
  ...
  *(_DWORD *)(v3 + 56) = 0;
  v9 = *(_BYTE *)(v3 + 76);
  *(_DWORD *)v3 = &off_6689F0;
  *(_DWORD *)(v3 + 64) = &off_66D3F4;
  *(_DWORD *)(v3 + 68) = 0;
  *(_DWORD *)(v3 + 72) = 6;
  v10 = v8 & 1 | v9 & 0xF0 | 2;
  *(_BYTE *)(v3 + 76) = v10;
  ...
  *(_BYTE *)(v3 + 76) = v10 & 0xF7 | *(_BYTE *)(a1 + 76) & 8;
...
// Address: 0x49b518
// Original: _ZNK22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE11GetTaskTypeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::GetTaskType(void)
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::GetTaskType()
{
  return 907;
}
...
// Address: 0x49b520
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE13MakeAbortableEP4CPediPK6CEvent
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::MakeAbortable(CPed *,int,CEvent const*)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::MakeAbortable(int a1, int a2, int a3)
{
  int v4; // lr
  int result; // r0
  int v6; // r1
...
// Address: 0x49b570
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE9SerializeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::Serialize(void)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::Serialize(_DWORD *a1)
{
  char v2; // r6
  __int16 v3; // r2
  __int16 v4; // r4
...
// Address: 0x49b98c
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE17CreateNextSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateNextSubTask(CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateNextSubTask(int a1, int a2)
{
  int v4; // r0
      ...
      if ( v4 != 719 )
      {
        ...
        if ( v8 )
        {
          ...
          CEntitySeekPosCalculatorVehicleId::ComputeEntitySeekPos(
            (CEntitySeekPosCalculatorVehicleId *)(a1 + 64),
            (const CPed *)a2,
            *(const CEntity **)(a1 + 12),
            (CVector *)v15);
          v10 = v9 + 6;
          ...
          if ( (float)((float)(*(float *)&v12 + *((float *)&v12 + 1)) + 0.0) <= (float)(*(float *)(a1 + 24)
                                                                                      * *(float *)(a1 + 24)) )
            *(_BYTE *)(a1 + 76) |= 4u;
          return CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateSubTask();
        }
        return (int)v5;
      }
    }
...
// Address: 0x49bb24
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE18CreateFirstSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateFirstSubTask(CPed *)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateFirstSubTask(int a1, CPed *a2)
{
  __int64 v4; // kr00_8
  unsigned int v5; // r1
  const CEntity *v6; // r2
  ...
  *(_DWORD *)(a1 + 44) = HIDWORD(v4);
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateSubTask();
    }
    else
    {
...
// Address: 0x49bc30
// Original: _ZN22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE14ControlSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::ControlSubTask(CPed *)
CTaskSimpleStandStill *__fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::ControlSubTask(
        int a1,
        CPedGroups *this,
        const CPed *a3)
{
                        ...
                        0) == 1 )
            {
              ...
              CTaskComplexGoToPointAndStandStill::CTaskComplexGoToPointAndStandStill(
                ...
                *(float *)(a1 + 28),
                0,
                0);
              *((_BYTE *)v6 + 36) = *(_BYTE *)(a1 + 76) & 8 | *((_BYTE *)v6 + 36) & 0xF7;
              return v6;
            }
          }
          else
...
// Address: 0x49c240
// Original: _ZNK22CTaskComplexSeekEntityI33CEntitySeekPosCalculatorVehicleIdE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateSubTask(int,CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorVehicleId>::CreateSubTask(int a1, int a2, CVehicle **a3)
{
  int v5; // r4
  int v6; // r8
  unsigned int v7; // r1
    ...
    else if ( a2 == 903 )
    {
      ...
      CTaskComplexGoToPointAndStandStill::CTaskComplexGoToPointAndStandStill(
        ...
        *(float *)(a1 + 28),
        0,
        0);
      *(_BYTE *)(v5 + 36) = *(_BYTE *)(a1 + 76) & 8 | *(_BYTE *)(v5 + 36) & 0xF7;
    }
  }
  else if ( a2 > 243 )
  {
