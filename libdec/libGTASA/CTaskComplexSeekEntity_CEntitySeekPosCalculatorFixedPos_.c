...
// Address: 0x18e848
// Original: j__ZNK22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateSubTask(int,CPed *)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateSubTask()
{
  return _ZNK22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE13CreateSubTaskEiP4CPed();
}
...
// Address: 0x191ec0
// Original: j__ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateTask(void)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateTask()
{
  return _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE10CreateTaskEv();
}
...
// Address: 0x495690
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateTask(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateTask(int a1, int a2, int a3)
{
  char v3; // r4
  char *v4; // r1
  int v5; // r2
...
LABEL_20:
  ...
  *(_DWORD *)(v11 + 80) = 6;
  v12 = *(_BYTE *)(v11 + 84);
  *(_DWORD *)v11 = &off_668A68;
  *(_DWORD *)(v11 + 64) = &off_66D40C;
...
// Address: 0x49d4c8
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosED2Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
  CEntity **v3; // r1
...
// Address: 0x49d4f4
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosED0Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
...
// Address: 0x49d524
// Original: _ZNK22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE5CloneEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::Clone(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::Clone(int a1, unsigned int a2)
{
  int v3; // r5
  __int64 v4; // d8
  __int64 v5; // d9
  ...
  *(_DWORD *)(v3 + 72) = 0;
  *(_DWORD *)(v3 + 76) = 0;
  *(_DWORD *)v3 = &off_668A68;
  *(_DWORD *)(v3 + 64) = &off_66D40C;
  v10 = v8 & 1 | v9 & 0xF0 | 2;
  *(_BYTE *)(v3 + 84) = v10;
  *(_DWORD *)(v3 + 68) = 0;
  *(_DWORD *)(v3 + 12) = v6;
...
// Address: 0x49d600
// Original: _ZNK22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE11GetTaskTypeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::GetTaskType(void)
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::GetTaskType()
{
  return 907;
}
...
// Address: 0x49d608
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE13MakeAbortableEP4CPediPK6CEvent
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::MakeAbortable(CPed *,int,CEvent const*)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::MakeAbortable(int a1, int a2, int a3)
{
  int v4; // lr
  int result; // r0
  int v6; // r1
...
// Address: 0x49d658
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE9SerializeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::Serialize(void)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::Serialize(_DWORD *a1)
{
  char v2; // r6
  __int16 v3; // r2
  __int16 v4; // r4
...
// Address: 0x49da74
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE17CreateNextSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateNextSubTask(CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateNextSubTask(int a1, int a2)
{
  int v4; // r0
      ...
      if ( v4 != 719 )
      {
        ...
        if ( v8 )
        {
          ...
          CEntitySeekPosCalculatorFixedPos::ComputeEntitySeekPos(
            (CEntitySeekPosCalculatorFixedPos *)(a1 + 64),
            (const CPed *)a2,
            *(const CEntity **)(a1 + 12),
            (CVector *)v15);
          v10 = v9 + 6;
          ...
          if ( (float)((float)(*(float *)&v12 + *((float *)&v12 + 1)) + 0.0) <= (float)(*(float *)(a1 + 24)
                                                                                      * *(float *)(a1 + 24)) )
            *(_BYTE *)(a1 + 84) |= 4u;
          return CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateSubTask();
        }
        return (int)v5;
      }
    }
...
// Address: 0x49dc0c
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE18CreateFirstSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateFirstSubTask(CPed *)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateFirstSubTask(int a1, CPed *a2)
{
  __int64 v4; // kr00_8
  unsigned int v5; // r1
  const CEntity *v6; // r2
  ...
  *(_DWORD *)(a1 + 44) = HIDWORD(v4);
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateSubTask();
    }
    else
    {
...
// Address: 0x49dd18
// Original: _ZN22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE14ControlSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::ControlSubTask(CPed *)
CTaskSimpleStandStill *__fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::ControlSubTask(
        int a1,
        CPedGroups *this,
        const CPed *a3)
{
...
// Address: 0x49e328
// Original: _ZNK22CTaskComplexSeekEntityI32CEntitySeekPosCalculatorFixedPosE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateSubTask(int,CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorFixedPos>::CreateSubTask(int a1, int a2, CVehicle **a3)
{
  int v5; // r4
  int v6; // r8
  unsigned int v7; // r1
