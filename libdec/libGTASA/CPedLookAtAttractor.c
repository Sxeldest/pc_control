...
// Address: 0x4ac6cc
// Original: _ZNK19CPedLookAtAttractor7GetTypeEv
// Demangled: CPedLookAtAttractor::GetType(void)
int __fastcall CPedLookAtAttractor::GetType(CPedLookAtAttractor *this)
{
  return 6;
}
...
// Address: 0x4ac6d0
// Original: _ZN19CPedLookAtAttractorD0Ev
// Demangled: CPedLookAtAttractor::~CPedLookAtAttractor()
