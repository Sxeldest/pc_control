...
// Address: 0x18d3a0
// Original: j__ZNK22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateSubTask(int,CPed *)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateSubTask()
{
  return _ZNK22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE13CreateSubTaskEiP4CPed();
}
...
// Address: 0x197ad8
// Original: j__ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateTask(void)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateTask()
{
  return _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE10CreateTaskEv();
}
...
// Address: 0x4954f0
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateTask(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateTask(int a1, int a2, int a3)
{
  char v3; // r4
  char *v4; // r1
  int v5; // r2
...
LABEL_20:
  ...
  *(_DWORD *)(v11 + 80) = 6;
  v12 = *(_BYTE *)(v11 + 84);
  *(_DWORD *)v11 = &off_668A2C;
  *(_DWORD *)(v11 + 64) = &off_66D400;
...
// Address: 0x49c454
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingED2Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
  CEntity **v3; // r1
...
// Address: 0x49c480
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingED0Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
...
// Address: 0x49c4b0
// Original: _ZNK22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE5CloneEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::Clone(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::Clone(int a1, unsigned int a2)
{
  int v3; // r5
  __int64 v4; // d8
  __int64 v5; // d9
  ...
  *(_DWORD *)(v3 + 72) = 0;
  *(_DWORD *)(v3 + 76) = 0;
  *(_DWORD *)v3 = &off_668A2C;
  *(_DWORD *)(v3 + 64) = &off_66D400;
  v10 = v8 & 1 | v9 & 0xF0 | 2;
  *(_BYTE *)(v3 + 84) = v10;
  *(_DWORD *)(v3 + 68) = 0;
  *(_DWORD *)(v3 + 12) = v6;
...
// Address: 0x49c58c
// Original: _ZNK22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE11GetTaskTypeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::GetTaskType(void)
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::GetTaskType()
{
  return 907;
}
...
// Address: 0x49c594
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE13MakeAbortableEP4CPediPK6CEvent
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::MakeAbortable(CPed *,int,CEvent const*)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::MakeAbortable(int a1, int a2, int a3)
{
  int v4; // lr
  int result; // r0
  int v6; // r1
...
// Address: 0x49c5e4
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE9SerializeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::Serialize(void)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::Serialize(_DWORD *a1)
{
  char v2; // r6
  __int16 v3; // r2
  __int16 v4; // r4
...
// Address: 0x49ca00
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE17CreateNextSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateNextSubTask(CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateNextSubTask(int a1, int a2)
{
  int v4; // r0
      ...
      if ( v4 != 719 )
      {
        ...
        if ( v8 )
        {
          ...
          CEntitySeekPosCalculatorDriving::ComputeEntitySeekPos(
            (CEntitySeekPosCalculatorDriving *)(a1 + 64),
            (const CPed *)a2,
            *(const CEntity **)(a1 + 12),
            (CVector *)v15);
          v10 = v9 + 6;
          ...
          if ( (float)((float)(*(float *)&v12 + *((float *)&v12 + 1)) + 0.0) <= (float)(*(float *)(a1 + 24)
                                                                                      * *(float *)(a1 + 24)) )
            *(_BYTE *)(a1 + 84) |= 4u;
          return CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateSubTask();
        }
        return (int)v5;
      }
    }
...
// Address: 0x49cb98
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE18CreateFirstSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateFirstSubTask(CPed *)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateFirstSubTask(int a1, CPed *a2)
{
  __int64 v4; // kr00_8
  unsigned int v5; // r1
  const CEntity *v6; // r2
  ...
  *(_DWORD *)(a1 + 44) = HIDWORD(v4);
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateSubTask();
    }
    else
    {
...
// Address: 0x49cca4
// Original: _ZN22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE14ControlSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::ControlSubTask(CPed *)
CTaskSimpleStandStill *__fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::ControlSubTask(
        int a1,
        CPedGroups *this,
        const CPed *a3)
{
...
// Address: 0x49d2b4
// Original: _ZNK22CTaskComplexSeekEntityI31CEntitySeekPosCalculatorDrivingE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateSubTask(int,CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorDriving>::CreateSubTask(int a1, int a2, CVehicle **a3)
{
  int v5; // r4
  int v6; // r8
  unsigned int v7; // r1
