...
// Address: 0x4ac438
// Original: _ZNK17CPedSeatAttractor7GetTypeEv
// Demangled: CPedSeatAttractor::GetType(void)
int __fastcall CPedSeatAttractor::GetType(CPedSeatAttractor *this)
{
  return 1;
}
...
// Address: 0x4ac498
// Original: _ZN17CPedSeatAttractorD0Ev
// Demangled: CPedSeatAttractor::~CPedSeatAttractor()
