...
// Address: 0x4ac870
// Original: _ZNK17CPedStepAttractor7GetTypeEv
// Demangled: CPedStepAttractor::GetType(void)
int __fastcall CPedStepAttractor::GetType(CPedStepAttractor *this)
{
  return 9;
}
...
// Address: 0x4ac874
// Original: _ZN17CPedStepAttractorD0Ev
// Demangled: CPedStepAttractor::~CPedStepAttractor()
