...
// Address: 0x18c950
// Original: j__ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateTask(void)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateTask()
{
  return _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE10CreateTaskEv();
}
...
// Address: 0x194578
// Original: j__ZNK22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateSubTask(int,CPed *)
// attributes: thunk
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateSubTask()
{
  return _ZNK22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE13CreateSubTaskEiP4CPed();
}
...
// Address: 0x4951d0
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE10CreateTaskEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateTask(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateTask(int a1, int a2, int a3)
{
  char v3; // r4
  char *v4; // r1
  int v5; // r2
...
LABEL_20:
  ...
  *(_DWORD *)(v11 + 68) = 6;
  v12 = *(_BYTE *)(v11 + 72);
  *(_DWORD *)v11 = &off_6689B4;
  *(_DWORD *)(v11 + 64) = &off_66D3E8;
...
// Address: 0x49a398
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceED2Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
  CEntity **v3; // r1
...
// Address: 0x49a3c4
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceED0Ev
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::~CTaskComplexSeekEntity()
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::~CTaskComplexSeekEntity(CEntity **a1)
{
  CEntity *v2; // r0
...
// Address: 0x49a3f4
// Original: _ZNK22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE5CloneEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::Clone(void)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::Clone(int a1, unsigned int a2)
{
  int v3; // r5
  __int64 v4; // d8
  __int64 v5; // d9
  ...
  *(_DWORD *)(v3 + 56) = 0;
  v9 = *(_BYTE *)(v3 + 72);
  *(_DWORD *)v3 = &off_6689B4;
  *(_DWORD *)(v3 + 64) = &off_66D3E8;
  *(_DWORD *)(v3 + 68) = 6;
  v10 = v8 & 1 | v9 & 0xF0 | 2;
  *(_BYTE *)(v3 + 72) = v10;
  *(_DWORD *)(v3 + 12) = v6;
...
// Address: 0x49a4bc
// Original: _ZNK22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE11GetTaskTypeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::GetTaskType(void)
int CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::GetTaskType()
{
  return 907;
}
...
// Address: 0x49a4c4
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE13MakeAbortableEP4CPediPK6CEvent
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::MakeAbortable(CPed *,int,CEvent const*)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::MakeAbortable(int a1, int a2, int a3)
{
  int v4; // lr
  int result; // r0
  int v6; // r1
...
// Address: 0x49a514
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE9SerializeEv
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::Serialize(void)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::Serialize(_DWORD *a1)
{
  char v2; // r6
  __int16 v3; // r2
  __int16 v4; // r4
...
// Address: 0x49a928
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE17CreateNextSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateNextSubTask(CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateNextSubTask(int a1, int a2)
{
  int v4; // r0
      ...
      if ( v4 != 719 )
      {
        ...
        if ( v8 )
        {
          ...
          CEntitySeekPosCalculatorEntitySurface::ComputeEntitySeekPos(
            (CEntitySeekPosCalculatorEntitySurface *)(a1 + 64),
            (const CPed *)a2,
            *(const CEntity **)(a1 + 12),
            (CVector *)v15);
          v10 = v9 + 6;
          ...
          if ( (float)((float)(*(float *)&v12 + *((float *)&v12 + 1)) + 0.0) <= (float)(*(float *)(a1 + 24)
                                                                                      * *(float *)(a1 + 24)) )
            *(_BYTE *)(a1 + 72) |= 4u;
          return CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateSubTask();
        }
        return (int)v5;
      }
    }
...
// Address: 0x49aac0
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE18CreateFirstSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateFirstSubTask(CPed *)
void __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateFirstSubTask(int a1, CPed *a2)
{
  __int64 v4; // kr00_8
  unsigned int v5; // r1
  const CEntity *v6; // r2
  ...
  *(_DWORD *)(a1 + 44) = HIDWORD(v4);
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateSubTask();
    }
    else
    {
...
// Address: 0x49abcc
// Original: _ZN22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE14ControlSubTaskEP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::ControlSubTask(CPed *)
CTaskSimpleStandStill *__fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::ControlSubTask(
        int a1,
        CPedGroups *this,
        const CPed *a3)
{
...
// Address: 0x49b1dc
// Original: _ZNK22CTaskComplexSeekEntityI37CEntitySeekPosCalculatorEntitySurfaceE13CreateSubTaskEiP4CPed
// Demangled: CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateSubTask(int,CPed *)
int __fastcall CTaskComplexSeekEntity<CEntitySeekPosCalculatorEntitySurface>::CreateSubTask(
        int a1,
        int a2,
        CVehicle **a3)
{
