...
// Address: 0x4ac7e4
// Original: _ZNK17CPedParkAttractor7GetTypeEv
// Demangled: CPedParkAttractor::GetType(void)
int __fastcall CPedParkAttractor::GetType(CPedParkAttractor *this)
{
  return 8;
}
...
// Address: 0x4ac7e8
// Original: _ZN17CPedParkAttractorD0Ev
// Demangled: CPedParkAttractor::~CPedParkAttractor()
