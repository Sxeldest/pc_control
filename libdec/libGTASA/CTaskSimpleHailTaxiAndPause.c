...
// Address: 0x4970b0
// Original: _ZN27CTaskSimpleHailTaxiAndPauseD0Ev
// Demangled: CTaskSimpleHailTaxiAndPause::~CTaskSimpleHailTaxiAndPause()
...
// Address: 0x4970c0
// Original: _ZNK27CTaskSimpleHailTaxiAndPause5CloneEv
// Demangled: CTaskSimpleHailTaxiAndPause::Clone(void)
_DWORD *__fastcall CTaskSimpleHailTaxiAndPause::Clone(CTaskSimpleHailTaxiAndPause *this, unsigned int a2)
{
  int v3; // r0
  _DWORD *result; // r0
...
// Address: 0x497110
// Original: _ZN27CTaskSimpleHailTaxiAndPause9SerializeEv
// Demangled: CTaskSimpleHailTaxiAndPause::Serialize(void)
void __fastcall CTaskSimpleHailTaxiAndPause::Serialize(CTaskSimpleHailTaxiAndPause *this)
{
  ...
  v2 = (*(int (__fastcall **)(CTaskSimpleHailTaxiAndPause *))(*(_DWORD *)this + 20))(this);
  v3 = UseDataFence;
  if ( UseDataFence )
  {
  ...
  *(_DWORD *)v8 = v2;
  ...
  free(v8);
  if ( (*(int (__fastcall **)(CTaskSimpleHailTaxiAndPause *))(*(_DWORD *)this + 20))(this) == 279 )
  {
    v10 = UseDataFence;
    if ( UseDataFence )
    {
  ...
  {
    v17 = (*(int (__fastcall **)(CTaskSimpleHailTaxiAndPause *))(*(_DWORD *)this + 20))(this);
    sub_5E6BC0(v18, "ERROR - class %d is not type %d serialize is not this class expected", v17, 279);
  }
}
...
// Address: 0x49728c
// Original: _ZNK27CTaskSimpleHailTaxiAndPause15IsInterruptableEPK4CPed
// Demangled: CTaskSimpleHailTaxiAndPause::IsInterruptable(CPed const*)
int __fastcall CTaskSimpleHailTaxiAndPause::IsInterruptable(CTaskSimpleHailTaxiAndPause *this, const CPed *a2)
{
  return 0;
}
