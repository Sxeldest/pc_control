// ADDR: 0x10a718
// SYMBOL: sub_10A718
int __fastcall sub_10A718(int a1, int a2, _DWORD *a3, char a4)
{
  int i; // r6
  int v8; // r7
  int result; // r0
  ...
  for ( i = 1; ; --i )
  {
    ...
    if ( (a4 & 1) != 0 )
    {
      ...
      if ( !i )
      {
        sub_10ABD4(a2, -1, a3[4]);
        a4 = 0;
      }
    }
    sub_10AB7C(a2, -2, v18);
    result = sub_10AD8C(a2, v14);
    if ( result )
      break;
    v10 = v15;
    if ( v15 )
...
// ADDR: 0x10aaa0
// SYMBOL: sub_10AAA0
int __fastcall sub_10AAA0(int a1, __int64 *a2)
{
  __int64 v3; // r2
  int v4; // r0
  __int64 *v5; // r1
  ...
  *(_BYTE *)(a1 + 78) = 0;
  HIDWORD(v3) = &unk_1AF8BC;
  LODWORD(v3) = off_1148F8;
  *(_WORD *)(a1 + 76) = 0;
  v4 = a1 + 8;
  *(_QWORD *)a1 = v3;
  v6 = *a2;
...
// ADDR: 0x10c110
// SYMBOL: sub_10C110
int __fastcall sub_10C110(_DWORD *a1, int a2, int a3, int a4, int a5)
{
  int v5; // r4
  int v6; // r5
  int v7; // r6
