// ADDR: 0xf65a4
// SYMBOL: sub_F65A4
int __fastcall sub_F65A4(int a1, unsigned int a2, int a3, _DWORD *a4)
{
  __int64 v6; // r0
  unsigned int v7; // r8
  int v8; // r1
  ...
  if ( a2 <= (HIDWORD(v6) - (int)v6) >> 2 )
    return sub_F62E4(a1, a2);
  v7 = sub_F64C4((_DWORD *)a1, a2 + (((int)v6 - *(_DWORD *)a1) >> 2));
  v8 = *(_DWORD *)(a1 + 4) - *(_DWORD *)a1;
  v20 = a1 + 16;
  v9 = v8 >> 2;
  if ( v7 )
    v10 = sub_F631C(a1 + 16, v7);
  else
    v10 = 0;
  v11 = v10 + 4 * v7;
  v16 = v10;
