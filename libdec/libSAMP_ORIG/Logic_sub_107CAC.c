// ADDR: 0x107c5c
// SYMBOL: sub_107C5C
int __fastcall sub_107C5C(int a1, void *lpsrc)
{
  _BOOL4 v4; // r2
  _BYTE *v5; // r0
  ...
  {
    v4 = 1;
    return sub_107A64(a1, (int)lpsrc, v4);
  }
  if ( lpsrc )
  {
    v5 = j___dynamic_cast(
...
// ADDR: 0x107eb0
// SYMBOL: sub_107EB0
int __fastcall sub_107EB0(_DWORD *a1, void *lpsrc)
{
  int v3; // r6
  _DWORD *v4; // r0
  int v5; // r1
  ...
  v10 = j___dynamic_cast(
          ...
          0);
  if ( v10 )
    return sub_107F48((int)v10, (void *)v6[3]);
  return v3;
}
...
// ADDR: 0x107f48
// SYMBOL: sub_107F48
bool __fastcall sub_107F48(_DWORD *a1, void *lpsrc)
{
  int v3; // r5
  _DWORD *v4; // r0
