// ADDR: 0x84538
// SYMBOL: sub_84538
std::__ndk1 *__fastcall sub_84538(std::__ndk1 *result, std::__ndk1 *this)
{
  std::__ndk1 *v2; // r4
  std::__ndk1 *v3; // r5
  unsigned int v4; // r6
  ...
  if ( (unsigned int)v3 > v4 )
    return (std::__ndk1 *)sub_8461C(v2, v3);
  if ( (unsigned int)v3 < v4 )
  {
...
// ADDR: 0x109688
// SYMBOL: sub_109688
int __fastcall sub_109688(unsigned int a1, unsigned int a2)
{
  int result; // r0
  unsigned int v3; // [sp+0h] [bp-8h] BYREF
