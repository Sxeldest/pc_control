// ADDR: 0xff2b8
// SYMBOL: sub_FF2B8
int __fastcall sub_FF2B8(_DWORD *a1, int a2)
{
  __int64 v4; // r0
  unsigned int v5; // r2
  int v6; // r3
  ...
  if ( v6 == 90 )
  {
    ...
    *a1 = v11 + 1;
    if ( (_DWORD)v11 + 1 != HIDWORD(v11) )
    {
      ...
      {
        *a1 = v11 + 2;
        sub_FE75C(v40, (unsigned __int8 **)a1, 1);
        v39 = *(_QWORD *)a1;
        ...
        if ( *(_BYTE *)v39 != 95 )
          return 0;
        *a1 = v39 + 1;
        v40[0] = (unsigned __int8 *)sub_FF2B8(a1, a2);
        if ( !v40[0] )
          return 0;
        return sub_1054D0(a1, &v44, v40);
      }
      if ( v12 == 115 )
      {
        LODWORD(v11) = v11 + 2;
        *a1 = v11;
        *a1 = sub_10546A(v11, HIDWORD(v11));
        v40[0] = (unsigned __int8 *)sub_104CD4(a1, "string literal");
        return sub_1054D0(a1, &v44, v40);
      }
    }
    v40[0] = (unsigned __int8 *)sub_FF2B8(a1, a2);
...
LABEL_54:
          ...
          if ( sub_FE18C((__int64 *)a1, (int)"St", (int)"") )
            v41 = sub_FFFD8(a1, "std");
          while ( 1 )
          {
            while ( 1 )
            {
            ...
            switch ( v22 )
            {
              case 'I':
                ...
                if ( v42 )
                  v34 = 1;
                v44 = sub_FFCD8(a1, v34);
                if ( !v44 || !v41 )
                  return 0;
                v41 = sub_FFF64(a1, &v41, &v44);
                if ( v42 )
                  v42[1] = 1;
LABEL_108:
                sub_FF894(a1 + 37, &v41);
              ...
              default:
LABEL_105:
                v23 = sub_100334(a1, v42);
LABEL_106:
                v35 = sub_100010(v40, v23);
LABEL_107:
                if ( !v35 )
                  return 0;
                goto LABEL_108;
...
LABEL_79:
          ...
          if ( *(_BYTE *)(v41 + 4) == 41 )
          {
            ...
            {
              v28 = (_DWORD *)sub_FFA98(a1 + 102, 12);
              *v28 = &off_113AF0;
              v28[1] = 16843048;
              v28[2] = v27;
              v41 = (int)v28;
            ...
            if ( (_BYTE *)HIDWORD(v19) != v29 )
            {
              ...
              if ( (unsigned int)(v37 - 49) <= 4 )
              {
                *a1 = v29 + 1;
                ...
                if ( v26 )
                  *v26 = 1;
                if ( !(_DWORD)v19 || sub_FF2B8(a1, v26) )
                {
                  v33 = 0;
LABEL_120:
                  v43 = v33;
                  v31 = sub_105264(a1, &v41, &v43, &v44);
LABEL_122:
                  if ( !sub_100010(v40, v31) )
                    return 0;
                  v35 = sub_1002A4(a1, v41);
                  v41 = v35;
                  goto LABEL_107;
                }
              }
  ...
  {
LABEL_27:
    if ( sub_FE18C((__int64 *)a1, (int)"StL", (int)"") || sub_FE18C((__int64 *)a1, (int)"St", (int)"") )
    {
      v13 = sub_100334(a1, a2);
      if ( !v13 )
        return 0;
      v14 = v13;
      result = sub_FFA98(a1 + 102, 12);
      *(_DWORD *)(result + 8) = v14;
      v40[0] = (unsigned __int8 *)result;
      *(_DWORD *)result = &off_113CE8;
      *(_DWORD *)(result + 4) = 16843047;
    }
    else
    {
      result = sub_100334(a1, a2);
      v40[0] = (unsigned __int8 *)result;
      if ( !result )
        return 0;
    }
  ...
  v40[0] = (unsigned __int8 *)sub_FFBB4(a1);
  if ( !v40[0] )
    return 0;
  v18 = *(_QWORD *)a1;
...
LABEL_35:
  ...
  if ( a2 )
    v17 = 1;
  v44 = sub_FFCD8(a1, v17);
  if ( !v44 )
    return 0;
  if ( a2 )
    *(_BYTE *)(a2 + 1) = 1;
  return sub_FFF64(a1, v40, &v44);
}
...
// ADDR: 0xff730
// SYMBOL: sub_FF730
int __fastcall sub_FF730(__int64 **a1)
{
  __int64 v1; // r0
  int result; // r0
  int v3; // r1
...
// ADDR: 0xff754
// SYMBOL: sub_FF754
_DWORD *__fastcall sub_FF754(int a1)
{
  __int64 v2; // r0
  int v3; // r3
  _DWORD *result; // r0
  ...
  if ( HIDWORD(v2) == (_DWORD)v2 )
    return (_DWORD *)sub_FE7F0((unsigned __int8 **)a1);
  ...
  if ( v3 != 74 )
  {
    if ( v3 == 76 )
    {
      if ( (unsigned int)(HIDWORD(v2) - v2) < 2 || *(_BYTE *)(v2 + 1) != 90 )
        return (_DWORD *)sub_101F48(a1, _stack_chk_guard);
      *(_DWORD *)a1 = v2 + 2;
      result = (_DWORD *)sub_FE1FC(a1);
      goto LABEL_15;
    }
    if ( v3 == 88 )
    {
      *(_DWORD *)a1 = v2 + 1;
      result = (_DWORD *)sub_1006E0(a1);
LABEL_15:
      if ( !result )
        return 0;
      v8 = *(_QWORD *)a1;
  ...
  *(_DWORD *)a1 = v2 + 1;
  sub_FF908(v10, a1, v7);
  result = (_DWORD *)sub_FFA98(a1 + 408, 16);
  v9 = v10[1];
  result[2] = v10[0];
  result[3] = v9;
  *result = &off_113D20;
...
// ADDR: 0xff894
// SYMBOL: sub_FF894
int __fastcall sub_FF894(int a1, int *a2)
{
  char *v3; // r6
  void *v5; // r9
  int v6; // r10
...
// ADDR: 0xff908
// SYMBOL: sub_FF908
int __fastcall sub_FF908(int a1, int a2, int a3)
{
  int result; // r0

  sub_103E18(a1, a2, *(_DWORD *)(a2 + 8) + 4 * a3, *(_DWORD *)(a2 + 12));
...
// ADDR: 0xff928
// SYMBOL: sub_FF928
int __fastcall sub_FF928(int a1, int *a2, _DWORD *a3, __int64 *a4, int *a5, int *a6, _BYTE *a7)
{
  int result; // r0
  int v11; // r8
  int v12; // r12
...
// ADDR: 0xff984
// SYMBOL: sub_FF984
int __fastcall sub_FF984(unsigned __int8 **a1)
{
  __int64 v2; // r0
  int v3; // r4
...
// ADDR: 0xffa38
// SYMBOL: sub_FFA38
int __fastcall sub_FFA38(unsigned __int8 **a1, unsigned int *a2)
{
