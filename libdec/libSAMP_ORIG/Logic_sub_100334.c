// ADDR: 0x102c48
// SYMBOL: sub_102C48
int __fastcall sub_102C48(int a1, int a2)
{
  _DWORD *v3; // r5
  __int64 v4; // r0
  int v5; // r10
  ...
  if ( !sub_FE18C((__int64 *)a1, (int)"Ut", (int)"") )
  {
    if ( sub_FE18C((__int64 *)a1, (int)"Ul", (int)"") )
    {
      v5 = *(_DWORD *)(a1 + 392);
      *(_DWORD *)(a1 + 392) = (*(_DWORD *)(a1 + 336) - *(_DWORD *)(a1 + 332)) >> 2;
      ...
      sub_FF908((int)&v25, a1, v6);
      v14 = v26;
      if ( !v26 )
        *(_DWORD *)(a1 + 336) -= 4;
      v15 = _strlen_chk("vE", 3u);
      if ( sub_FE18C((__int64 *)a1, (int)"vE", (int)&aVe[v15]) )
      {
LABEL_31:
        sub_FF908((int)v24, a1, v6);
        v3 = 0;
        sub_FE75C(v23, (unsigned __int8 **)a1, 0);
        v17 = *(_QWORD *)a1;
      ...
      else
      {
        while ( 1 )
        {
          v24[0] = sub_FE7F0((unsigned __int8 **)a1);
          if ( !v24[0] )
            break;
          sub_FF894(a1 + 8, v24);
          v16 = *(_QWORD *)a1;
...
LABEL_35:
    ...
    if ( sub_FE18C((__int64 *)a1, (int)"Ub", (int)"") )
    {
      v3 = 0;
      sub_FE75C((unsigned __int8 **)v27, (unsigned __int8 **)a1, 0);
      v12 = *(_QWORD *)a1;
      ...
      {
        *(_DWORD *)a1 = v12 + 1;
        return sub_1034B8(a1, "'block-literal'");
      }
    }
    return 0;
  }
...
// ADDR: 0x104164
// SYMBOL: sub_104164
int __fastcall sub_104164(__int64 a1, int a2, int a3)
{
  __int64 *v3; // r4
  _DWORD *v4; // r5
  __int64 v5; // r0
  ...
  v4 = 0;
  v9[0] = 0;
  if ( !sub_10049E((unsigned __int8 **)a1, v9) )
  {
    v5 = *v3;
    if ( (unsigned int)(HIDWORD(v5) - v5) >= v9[0] && v9[0] )
    {
      ...
      *(_DWORD *)v3 = v6;
      HIDWORD(v8) = v6;
      if ( sub_FF274(&v8, (int)"_GLOBAL__N", (int)"") )
      {
        v4 = sub_FFA98((int)(v3 + 51), 16);
        *v4 = &off_113118;
        v4[1] = 16843015;
...
// ADDR: 0x10427c
// SYMBOL: sub_10427C
_DWORD *__fastcall sub_10427C(int a1, unsigned int a2)
{
  __int64 v4; // r0
  __int64 v5; // kr00_8
  unsigned int v6; // r2
  ...
  switch ( *(_BYTE *)v5 )
  {
    case 'a':
      ...
      if ( v9 == 78 )
      {
        *(_DWORD *)a1 = v5 + 2;
        v13 = "operator&=";
        return (_DWORD *)sub_104BC8(a1, v13);
      }
      if ( v9 == 83 )
      {
        *(_DWORD *)a1 = v5 + 2;
        v11 = "operator=";
        return (_DWORD *)sub_104C00(a1, v11);
      }
      v10 = v9 == 110;
      if ( v9 != 110 )
        v10 = v9 == 100;
        ...
        case 'v':
          ...
          *(_DWORD *)a1 = v5 + 2;
          if ( a2 | v24 )
            v25 = 1;
          *(_BYTE *)(a1 + 389) = v25;
          v29 = sub_FE7F0((unsigned __int8 **)a1);
          if ( v29 )
          {
            if ( a2 )
              *(_BYTE *)a2 = 1;
            result = (_DWORD *)sub_104C38(a1, &v29);
          }
          else
          {
            result = 0;
    ...
    case 'd':
      ...
      switch ( v12 )
      {
        ...
        case 'l':
          *(_DWORD *)a1 = v5 + 2;
          return sub_1034B8(a1, "operator delete");
        case 'a':
          *(_DWORD *)a1 = v5 + 2;
          return (_DWORD *)sub_104C64(a1, "operator delete[]");
        default:
          return 0;
      }
    case 'e':
    ...
    case 'l':
      ...
      if ( v19 == 83 )
      {
        *(_DWORD *)a1 = v5 + 2;
        v15 = "operator<<=";
        return (_DWORD *)sub_104C9C(a1, v15);
      }
      if ( v19 == 116 )
      {
        *(_DWORD *)a1 = v5 + 2;
...
LABEL_82:
    ...
    case 'n':
      ...
      switch ( v21 )
      {
        case 'w':
          *(_DWORD *)a1 = v5 + 2;
          return (_DWORD *)sub_104D0C(a1, "operator new");
        case 'e':
          *(_DWORD *)a1 = v5 + 2;
          v13 = "operator!=";
          return (_DWORD *)sub_104BC8(a1, v13);
...
LABEL_83:
      ...
      if ( v21 != 97 )
        return 0;
      *(_DWORD *)a1 = v5 + 2;
      return (_DWORD *)sub_104CD4(a1, "operator new[]");
    case 'o':
      if ( v6 < 2 )
        return 0;
    ...
    case 'v':
      ...
      *(_DWORD *)a1 = v5 + 2;
      LODWORD(v4) = a1;
      v28 = sub_104164(v4, v6, v7);
      if ( !v28 )
        return 0;
      return (_DWORD *)sub_104C38(a1, &v28);
    default:
      return result;
  }
}
