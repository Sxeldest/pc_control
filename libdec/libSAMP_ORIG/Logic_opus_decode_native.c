// ADDR: 0xb0f5c
// SYMBOL: sub_B0F5C
int __fastcall sub_B0F5C(_DWORD *a1, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v6; // r11
  int v8; // r5
  int v9; // r10
...
LABEL_24:
  ...
  while ( 1 )
  {
    ...
    if ( v33 < v9 )
      v34 = v33;
    v35 = sub_B0F5C(v6, 0, 0, v32, v34, 0);
    if ( v35 < 0 )
      break;
    v33 -= v35;
    v32 += 2 * v35 * v6[2];
