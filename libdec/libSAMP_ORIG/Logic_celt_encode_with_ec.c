        ...
        int a11)
{
  ...
  char *v64; // r4
  char *v65; // r11
  int v67; // [sp+20h] [bp-80h] BYREF
  int v68; // [sp+24h] [bp-7Ch]
  int v69; // [sp+28h] [bp-78h]
  size_t v70; // [sp+2Ch] [bp-74h]
  size_t v71; // [sp+30h] [bp-70h]
  size_t v72; // [sp+34h] [bp-6Ch]
  int v73; // [sp+38h] [bp-68h]
  _DWORD *v74; // [sp+3Ch] [bp-64h]
  int v75; // [sp+40h] [bp-60h]
  int v76; // [sp+44h] [bp-5Ch]
  void *v77; // [sp+48h] [bp-58h]
  int *v78; // [sp+4Ch] [bp-54h]
  int v79; // [sp+50h] [bp-50h]
  void *dest; // [sp+54h] [bp-4Ch]
  _DWORD *v81; // [sp+58h] [bp-48h]
  int v82; // [sp+5Ch] [bp-44h]
  void *v83; // [sp+60h] [bp-40h]
  size_t n; // [sp+64h] [bp-3Ch]
  int v85; // [sp+68h] [bp-38h]
  int v86; // [sp+6Ch] [bp-34h]
  int v87; // [sp+70h] [bp-30h] BYREF
  _DWORD v88[2]; // [sp+74h] [bp-2Ch] BYREF

  v12 = a5 + 1024;
  v81 = a1;
  v85 = *a1;
  v13 = *(_DWORD *)(v85 + 4);
  v88[0] = (char *)&v67 - ((4 * a4 * (a5 + 1024) + 7) & 0xFFFFFFF8);
  v88[1] = v88[0] + 4 * (a5 + 1024);
  v14 = &a2[4 * v13];
  v86 = v13;
  v15 = 4 * (v13 + a5);
  v16 = 0;
  ...
  if ( a10 )
  {
    v19 = (char *)&v67 - (((v12 & 0xFFFFFFFE) + 7) & 0xFFFFFFF8);
    v20 = v81;
    j_pitch_downsample((int)v88, v19, v12, a4, v81[18]);
    j_pitch_search(v19 + 1024, v19, a5, 979, &v87, v20[18]);
    v87 = 1024 - v87;
    v21 = v20[26];
    v22 = v20 + 26;
    v24 = *((__int16 *)v20 + 54);
    v23 = (__int16 *)(v20 + 27);
    v25 = j_remove_doubling((int)v19, 1024, 0xFu, a5, &v87, v21, v24);
    v26 = v87;
    v27 = v22;
    if ( v87 >= 1023 )
    {
  ...
  if ( v37 <= (__int16)v31 )
  {
    ...
    if ( v41 )
      LOWORD(v31) = *v23;
    HIWORD(v40) = 21845;
    v42 = ((__int16)v31 + 1536) >> 10;
    v43 = ((unsigned __int64)(v42 * (__int64)v40) >> 32)
        + ((unsigned int)((unsigned __int64)(v42 * (__int64)v40) >> 32) >> 31)
        - 1;
    if ( v43 >= 7 )
      v43 = 7;
    if ( v42 <= 5 )
  ...
  if ( a5 <= 1024 )
  {
    ...
    while ( 1 )
    {
      ...
      *v27 = v32;
      ...
      {
        j_comb_filter(&v39[v44], *v55 + 4096);
        v59 = &v88[v56];
      }
      v60 = v39;
      v61 = v59;
      j_comb_filter(&v60[4 * v75], *v59 + 4 * v58 + 4096);
      v62 = n;
      v63 = (char *)v77;
      j_memcpy(v77, &v60[n], v44);
      v64 = (char *)v83;
      j_memmove(v83, (char *)v83 + v62, v72);
      j_memcpy(&v64[v71 + 4096], (const void *)(*v61 + 4096), v62);
      v65 = v60;
      if ( v76 >= (int)dest )
        break;
      v27 = v78;
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      *v27 = v32;
      ...
      {
        j_comb_filter(&v39[v44], *v46 + 4096);
        v50 = v39;
        v51 = &v88[v47];
      }
      j_comb_filter(&v50[4 * v75], *v51 + 4 * v49 + 4096);
      v44 = v70;
      v52 = (char *)v77;
      j_memcpy(v77, &v50[n], v70);
      v53 = (char *)v83;
      j_memcpy(v83, (const void *)(*v51 + 4 * a5), 0x1000u);
      if ( v76 >= (int)dest )
        break;
      v27 = v78;
      v45 = &v52[v44];
...
// ADDR: 0xd9e18
// SYMBOL: sub_D9E18
bool __fastcall sub_D9E18(int a1, int a2, int a3, _WORD *a4, _DWORD *a5, int a6, _DWORD *a7)
{
  _DWORD *v10; // r8
  int v11; // r3
  int v12; // r12
  ...
  *a7 = 0;
  ...
  else
  {
    ...
    do
    {
      ...
      v52 = sub_108848(v75, ((v51 * v50) >> 1) + 1);
      if ( a2 < 36 )
      {
        v55 = 0;
        v14 = v81;
      ...
      else
      {
        ...
        do
        {
          ...
          if ( v58 >= 127 )
            v59 = 127;
          v49 = v58 <= 0;
          v60 = (unsigned __int8 *)&unk_5C9EF;
          if ( !v49 )
            v60 = (unsigned __int8 *)&unk_5C9EF + v59;
          v55 += *v60;
        }
        while ( v56 < v71 );
      }
      v61 = sub_108848(v55 << 8, v78);
      v13 = v82;
      v62 = v83;
      if ( v61 > v82 )
      {
...
// ADDR: 0xda1f4
// SYMBOL: sub_DA1F4
_DWORD *__fastcall sub_DA1F4(_DWORD *result, int a2, int a3, _DWORD *a4, _DWORD *a5, _DWORD *a6, int a7, int a8)
{
  _DWORD *v8; // r6
  _DWORD *v9; // r5
  int v10; // r4
  ...
  if ( a8 != 1 )
  {
    ...
    else
    {
      ...
      do
      {
        ...
        while ( v32 );
        sub_10967C((int)&v36[v30 + v25], v27);
        result = a5;
        ++v29;
        v28 += v12;
        v26 = v12;
...
// ADDR: 0xdacbc
// SYMBOL: sub_DACBC
int __fastcall sub_DACBC(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int *a11)
{
