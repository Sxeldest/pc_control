// ADDR: 0xfe074
// SYMBOL: sub_FE074
int __fastcall sub_FE074(unsigned __int8 *a1, int a2)
{
  int result; // r0
...
// ADDR: 0xfe09a
// SYMBOL: sub_FE09A
__int64 __fastcall sub_FE09A(__int64 *a1, char a2)
{
  __int64 result; // r0
...
// ADDR: 0xfe0b4
// SYMBOL: sub_FE0B4
_DWORD *__fastcall sub_FE0B4(_DWORD *a1)
{
  _DWORD **v2; // r5
  _DWORD *v3; // r6
  _DWORD *v4; // r0
...
// ADDR: 0xfe18c
// SYMBOL: sub_FE18C
int __fastcall sub_FE18C(__int64 *a1, int a2, int a3)
{
  int result; // r0
  __int64 v7; // [sp+4h] [bp-1Ch] BYREF

  v7 = *a1;
  result = sub_FF274(&v7, a2);
  if ( result )
    *(_DWORD *)a1 += a3 - a2;
  return result;
}
...
// ADDR: 0xfe1fc
// SYMBOL: sub_FE1FC
int __fastcall sub_FE1FC(int a1)
{
  __int64 v2; // r0
  int v3; // r2
  bool v4; // zf
        ...
        switch ( *(_BYTE *)(v2 + 1) )
        {
          ...
          case 'W':
            *(_DWORD *)a1 = v2 + 2;
            ...
            if ( !v57 )
              return (int)v9;
            return sub_FE7AC(a1, "thread-local wrapper routine for ", &v57);
          default:
            switch ( v6 )
            {
              case 'C':
...
LABEL_77:
  ...
  if ( v13 )
  {
    ...
    *(_DWORD *)(a1 + 364) = v14 + 4 * v15;
    ...
    {
      v55 = 0;
      if ( sub_FE18C((__int64 *)a1, (int)"Ua9enable_ifI", (int)"") )
      {
        ...
        *(_DWORD *)a1 = v30 + 1;
        sub_FF908(&v53, a1, v29);
        v48 = (_DWORD *)sub_FFA98(a1 + 408, 16);
        v49 = v54;
        v48[2] = v53;
        v48[3] = v49;
        *v48 = &off_113D58;
      ...
      if ( (_DWORD)v50 != HIDWORD(v50) && *(_BYTE *)v50 == 118 )
      {
        *(_DWORD *)a1 = v50 + 1;
        v53 = 0;
        v54 = 0;
        return sub_FF928(a1, &v52, &v56, &v53, &v55, &v58, v59);
      }
...
// ADDR: 0xfe75c
// SYMBOL: sub_FE75C
unsigned __int8 **__fastcall sub_FE75C(unsigned __int8 **result, unsigned __int8 **a2, int a3)
{
...
// ADDR: 0xfe7ac
// SYMBOL: sub_FE7AC
_DWORD *__fastcall sub_FE7AC(int a1, const char *a2, int *a3)
{
  _DWORD *v5; // r6
  size_t v6; // r0
  int v7; // r1
...
// ADDR: 0xfe7f0
// SYMBOL: sub_FE7F0
int __fastcall sub_FE7F0(unsigned __int8 **a1)
{
  __int64 v2; // kr00_8
  unsigned int v3; // r0
  int v4; // r3
...
LABEL_28:
      ...
      case 'M':
        ...
        *(_DWORD *)(v25 + 8) = v22;
        *(_DWORD *)(v25 + 12) = v24;
        *(_DWORD *)v25 = &off_113FF8;
        *(_BYTE *)(v25 + 5) = *(_BYTE *)(v24 + 5);
        goto LABEL_147;
      case 'O':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v64[0] = (unsigned __int8 *)sub_FE7F0(a1);
        if ( !v64[0] )
          return 0;
        v26 = 1;
        goto LABEL_42;
      case 'P':
        *a1 = (unsigned __int8 *)(v2 + 1);
        ...
        if ( !v27 )
          return 0;
        v28 = v27;
        v16 = sub_FFA98(a1 + 102, 12);
        *(_DWORD *)(v16 + 8) = v28;
        *(_WORD *)(v16 + 6) = 257;
        *(_BYTE *)(v16 + 4) = 11;
        *(_DWORD *)v16 = &off_114068;
...
LABEL_42:
      ...
      case 'T':
        ...
        if ( HIDWORD(v45) == (_DWORD)v45 || *(_BYTE *)v45 != 73 )
          goto LABEL_58;
        v64[0] = (unsigned __int8 *)sub_FFCD8(a1, 0);
        if ( !v64[0] )
          return 0;
        v30 = &v62;
        v31 = (int *)v64;
LABEL_100:
        v16 = sub_FFF64(a1, v30, v31);
LABEL_83:
        v62 = v16;
        goto LABEL_58;
      case 'U':
LABEL_18:
      ...
      case 'a':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v33 = "signed char";
        return sub_104C9C(a1, v33);
      case 'b':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v34 = "bool";
        return sub_100568(a1, v34);
      case 'c':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v34 = "char";
        return sub_100568(a1, v34);
      ...
      case 'f':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v37 = "float";
        return sub_102AF4(a1, v37);
      case 'g':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v38 = "__float128";
        return sub_104BC8(a1, v38);
      case 'h':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v39 = "unsigned char";
        return sub_105C84(a1, v39);
      case 'i':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v40 = "int";
        return sub_FFFD8(a1, v40);
      case 'j':
        *a1 = (unsigned __int8 *)(v2 + 1);
        return sub_104D0C(a1, "unsigned int");
      case 'l':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v34 = "long";
        return sub_100568(a1, v34);
      ...
      case 'n':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v41 = "__int128";
        return sub_105CBC(a1, v41);
      case 'o':
        *a1 = (unsigned __int8 *)(v2 + 1);
        return sub_104C64(a1, "unsigned __int128");
      case 's':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v37 = "short";
        return sub_102AF4(a1, v37);
      case 't':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v42 = "unsigned short";
        return sub_104CD4(a1, v42);
      case 'u':
        *a1 = (unsigned __int8 *)(v2 + 1);
        sub_10538C(v64, a1);
        if ( v64[0] == v64[1] )
          return 0;
        v16 = sub_10420C(a1, v64);
        goto LABEL_83;
      case 'v':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v34 = "void";
      ...
      case 'w':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v43 = "wchar_t";
        return sub_102C10(a1, v43);
      case 'x':
        *a1 = (unsigned __int8 *)(v2 + 1);
        v44 = "long long";
        return sub_104C00(a1, v44);
      case 'y':
        *a1 = (unsigned __int8 *)(v2 + 1);
        result = sub_FFA98(a1 + 102, 16);
    ...
    switch ( *(_BYTE *)(v2 + 1) )
    {
      ...
      case 'u':
        *a1 = (unsigned __int8 *)(v2 + 2);
        ...
        return sub_102C10(a1, v43);
      case 'v':
        if ( !sub_FE18C((__int64 *)a1, (int)"Dv", (int)"") )
          goto LABEL_146;
        v52 = *(_QWORD *)a1;
          ...
          if ( v53 == 95 )
          {
            *a1 = (unsigned __int8 *)(v52 + 1);
            ...
            if ( !v56 )
              goto LABEL_147;
            v57 = v56;
            v58 = (_DWORD *)sub_FFA98(a1 + 102, 16);
            v58[2] = v57;
            v58[3] = 0;
            *v58 = &off_113F88;
            v58[1] = 16843033;
...
LABEL_137:
          v64[0] = (unsigned __int8 *)sub_1006E0(a1);
          if ( v64[0] )
          {
            v59 = *(_QWORD *)a1;
            if ( (_DWORD)v59 != HIDWORD(v59) && *(_BYTE *)v59 == 95 )
            {
              *a1 = (unsigned __int8 *)(v59 + 1);
              ...
              if ( v63 )
              {
                ...
                v61 = (int *)v64;
LABEL_142:
                v58 = (_DWORD *)sub_106078(a1, v60, v61);
LABEL_143:
                v25 = (int)v58;
                goto LABEL_147;
              }
...
// ADDR: 0xffa98
// SYMBOL: sub_FFA98
_DWORD *__fastcall sub_FFA98(int a1, int a2)
{
  _DWORD *v3; // r5
  unsigned int v4; // r6
  int v5; // r2
