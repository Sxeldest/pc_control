// ADDR: 0x101f48
// SYMBOL: sub_101F48
int __fastcall sub_101F48(unsigned __int8 **a1)
{
  __int64 v2; // kr00_8
  _DWORD *v3; // r11
  int v4; // r0
  ...
  switch ( *(_BYTE *)(v2 + 1) )
  {
    case 'A':
      ...
      *a1 = (unsigned __int8 *)(v6 + 1);
      v3 = sub_FFA98((int)(a1 + 102), 12);
      v7 = 16843074;
      v8 = &`vtable for'`anonymous namespace'::itanium_demangle::StringLiteral;
      goto LABEL_22;
    case 'D':
      if ( !sub_FE18C((__int64 *)a1, (int)"DnE", (int)"") )
        return 0;
      return sub_102C10(a1, "nullptr");
    case 'T':
      return (int)v3;
    case 'U':
...
LABEL_22:
      *v3 = v8 + 2;
      ...
      return (int)v3;
    case '_':
      if ( !sub_FE18C((__int64 *)a1, (int)"_Z", (int)"") )
        return 0;
      v17 = sub_FE1FC((int)a1);
      if ( !v17 )
        return 0;
      v3 = (_DWORD *)v17;
      v18 = *(_QWORD *)a1;
    ...
    case 'a':
      *a1 = (unsigned __int8 *)(v2 + 2);
      v19 = "signed char";
      v20 = "";
      return sub_102B58(a1, v19, v20);
    case 'b':
      if ( sub_FE18C((__int64 *)a1, (int)"b0E", (int)"") )
      {
        v21 = 0;
      }
      else
      {
        if ( !sub_FE18C((__int64 *)a1, (int)"b1E", (int)"") )
          return 0;
        v21 = (_BYTE *)(&dword_0 + 1);
      }
      v32 = v21;
      return sub_102BE0(a1, &v32);
    case 'c':
      *a1 = (unsigned __int8 *)(v2 + 2);
      v19 = "char";
      v20 = "";
    ...
    case 'd':
      ...
      *a1 = (unsigned __int8 *)(v2 + 2);
      ...
      while ( v24 != 16 )
      {
        if ( !sub_102F84(*(unsigned __int8 *)(v22 + v24++)) )
          return (int)v3;
      }
      *a1 = v23;
    ...
    case 'e':
      ...
      *a1 = (unsigned __int8 *)(v2 + 2);
      ...
      while ( v26 != 16 )
      {
        if ( !sub_102F84(*(unsigned __int8 *)(v22 + v26++)) )
          return (int)v3;
      }
      *a1 = v23;
      if ( v23 == (unsigned __int8 *)HIDWORD(v2) || *v23 != 69 )
    ...
    case 'i':
      *a1 = (unsigned __int8 *)(v2 + 2);
      return sub_102B58(a1, &byte_4FDB8, &byte_4FDB8);
    case 'j':
      *a1 = (unsigned __int8 *)(v2 + 2);
      v19 = "u";
      goto LABEL_51;
...
LABEL_59:
  ...
  while ( v28 != 8 )
  {
    if ( !sub_102F84(*(unsigned __int8 *)(v22 + v28++)) )
      return (int)v3;
  }
  *a1 = v23;
  if ( v23 == (unsigned __int8 *)HIDWORD(v2) || *v23 != 69 )
