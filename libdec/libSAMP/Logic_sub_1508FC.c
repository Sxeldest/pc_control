// ADDR: 0x150f9c
// SYMBOL: sub_150F9C
int **__fastcall sub_150F9C(_DWORD *a1, unsigned __int16 *a2)
{
  unsigned int v2; // r4
  unsigned int v4; // r5
  unsigned int v5; // r0
...
// ADDR: 0x15106e
// SYMBOL: sub_15106E
int __fastcall sub_15106E(int a1, int a2, unsigned __int16 *a3, int a4, __int16 **a5, int **a6)
{
  int v6; // r9
  unsigned int v7; // r4
  unsigned int v9; // r6
...
// ADDR: 0x15e3e8
// SYMBOL: sub_15E3E8
int __fastcall sub_15E3E8(_DWORD *a1)
{
  int result; // r0

  sub_164B1C(a1[2]);
  result = sub_158D00((int)a1);
  if ( !result )
    return (*(int (__fastcall **)(_DWORD *))(*a1 + 8))(a1);
  return result;
}
...
// ADDR: 0x15e40c
// SYMBOL: sub_15E40C
int __fastcall sub_15E40C(int a1, int a2, int a3)
{
  int result; // r0
  char *exception; // r4
  int v5; // r0
  ...
  result = sub_164A80(a1, a2, a3, -1, 0);
  if ( !result )
  {
    exception = (char *)j___cxa_allocate_exception(0x18u);
    v5 = sub_1649EC(exception);
    sub_1545C8(exception, "Create voice stream", v5);
