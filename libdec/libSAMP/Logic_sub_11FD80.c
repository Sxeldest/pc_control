// ADDR: 0x11fae0
// SYMBOL: sub_11FAE0
_DWORD *__fastcall sub_11FAE0(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  *a1 = 0;
  sub_11FCDC(v10, sub_11FBE8, 0, a1);
  v3 = sub_11FE98(v12, v10);
  sub_11FE40(v3);
  v4 = dword_2638C0;
  if ( !dword_2638C0 )
  {
    v5 = sub_11FE98(v14, v12);
    sub_11FE40(v5);
    sub_11FEC4(&unk_2638B0, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6707584, sub_11FE08, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
