// ADDR: 0x13b500
// SYMBOL: sub_13B500
int __fastcall sub_13B500(int a1, float *a2, __int16 *a3, int a4, int a5, int a6)
{
  int v6; // r6
  unsigned int v7; // r4
  float *v8; // r10
  ...
  sub_13B6E8(&v36, v8, v9, a4, a5, a6);
  v21 = v8[4];
  v22 = (float)(unsigned int)(*((_DWORD *)v8 + 3) + 1);
  ...
  else
  {
    ...
    if ( (v24 | (unsigned int)v23) < v27 )
      v26 = (std::__ndk1 *)v27;
    sub_13B260((std::__ndk1 *)v8, v26);
    v7 = *((_DWORD *)v8 + 1);
    if ( (v7 & (v7 - 1)) != 0 )
    {
      if ( v7 <= v9 )
      {
        sub_221798(v9, *((_DWORD *)v8 + 1));
        v9 = v28;
      }
    }
    else
