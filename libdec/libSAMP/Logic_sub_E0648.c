// ADDR: 0xe0804
// SYMBOL: sub_E0804
unsigned __int8 *__fastcall sub_E0804(unsigned __int8 *a1, unsigned __int8 *a2, _DWORD *a3)
{
  int v5; // r0
...
// ADDR: 0xe09d8
// SYMBOL: sub_E09D8
int __fastcall sub_E09D8(int **a1)
{
  int result; // r0
