// ADDR: 0x19db94
// SYMBOL: sub_19DB94
size_t __fastcall sub_19DB94(__int16 *a1, int a2, int a3, int a4)
{
  char *v4; // lr
  bool v5; // cc
  int v6; // r11
  ...
  if ( a4 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        v8 = a2;
        v9 = &v4[2 * a2 * dword_C27A8[a3 - 2 + v6]];
        v10 = v7;
        do
        {
          v11 = *v10;
...
// ADDR: 0x19dc7c
// SYMBOL: sub_19DC7C
int __fastcall sub_19DC7C(int *a1, int a2, int a3, int a4, int a5, __int16 *a6, int a7, int a8, int a9)
{
  int v12; // r3
  __int64 v13; // kr08_8
  int v14; // r0
  ...
  if ( a7 != -1 && a3 >= 3 && *(unsigned __int8 *)(v17 + v16) + 12 < a4 )
  {
    ...
    v22 = 0;
    v70 = a2 + 2 * v19;
    sub_19E1CC(a1, v72, a2, v70, v19, &v78, v20 >> 1, a5, a7 - 1, 0, &a9);
    v63 = v73;
    v23 = v75;
    v64 = v74;
    v67 = v76;
    ...
    {
      v55 = a9;
      v71 = sub_19DC7C(a1, a2, v19, v22, v68, a6, a7 - 1, (__int16)((v63 * (__int16)a8 + 0x4000) >> 15), a9);
      v56 = v50;
      v57 = a1[8] - v62 + v22;
      if ( v57 > 24 )
        v56 = v50 + v57 - 24;
      if ( !v67 )
        v56 = v50;
      return (sub_19DC7C(a1, v70, v19, v56, v68, v45, a7 - 1, (__int16)((v64 * (__int16)a8 + 0x4000) >> 15), v55 >> v68) << (a5 >> 1)) | v71;
    }
    else
    {
      v61 = a9;
      v51 = sub_19DC7C(a1, v70, v19, v44 - v22, v68, v45, v21, (__int16)((v64 * (__int16)a8 + 0x4000) >> 15), a9 >> v68);
      v52 = v22;
      v53 = v51 << (a5 >> 1);
      v54 = a1[8] - v62 + v50;
      if ( v54 > 24 )
      ...
      if ( v67 == 0x4000 )
        v52 = v22;
      return sub_19DC7C(a1, a2, v19, v52, v68, a6, v21, (__int16)((v63 * (__int16)a8 + 0x4000) >> 15), v61) | v53;
    }
  }
  v24 = v16 + 1;
  v69 = a9;
    ...
    if ( v37 )
    {
      if ( a6 )
      {
        if ( a3 >= 1 )
        {
          ...
          do
          {
            v39 = v39 * (_DWORD)&loc_19660C + 1013904223;
            v41 = *v18++;
            --v38;
      ...
      else
      {
        ...
        if ( a3 >= 1 )
        {
          ...
          do
          {
            v58 = v58 * (_DWORD)&loc_19660C + 1013904223;
            --v59;
            *v60++ = v58 >> 20;
          }
          while ( v59 );
...
// ADDR: 0x19e0e4
// SYMBOL: sub_19E0E4
size_t __fastcall sub_19E0E4(char *a1, int a2, int a3, int a4)
{
  bool v4; // cc
  int v5; // r10
  char *v6; // r9
  ...
  if ( a4 )
  {
    ...
    if ( !v4 )
    {
      ...
      do
      {
        v7 = v6;
        v8 = a2;
        v9 = &a1[2 * dword_C27A8[a3 - 2 + v5] * a2];
        do
        {
          v10 = *(_WORD *)v9;
          v9 += 2;
