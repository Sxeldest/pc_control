// ADDR: 0xeb6fc
// SYMBOL: sub_EB6FC
int __fastcall sub_EB6FC(__int64 a1)
{
  __int64 v1; // r4
  __int64 v2; // kr00_8
  __int64 v3; // d16
  ...
  if ( (unsigned int)v2 >= (unsigned int)a1 )
  {
    ...
    *(_DWORD *)(v12 + 8) = 0;
    *(_DWORD *)(v8 + 12) = 0;
    v9 = *(_QWORD *)HIDWORD(v1);
    *(_BYTE *)v8 = 0;
    sub_EA660((unsigned __int8 *)v8, 0, v9, HIDWORD(v9));
    v12 += 16;
  ...
  else
  {
    ...
    *(_BYTE *)v2 = 0;
    sub_EA660((unsigned __int8 *)v2, SHIDWORD(a1), v3, HIDWORD(v3));
    v4 = v2 + 16;
    *(_DWORD *)(v1 + 4) = v2 + 16;
  }
  return v4 - 16;
