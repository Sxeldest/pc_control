// ADDR: 0x15f4fa
// SYMBOL: sub_15F4FA
std::__ndk1 *__fastcall sub_15F4FA(std::__ndk1 *result, std::__ndk1 *this)
{
  std::__ndk1 *v2; // r4
  std::__ndk1 *v3; // r5
  unsigned int v4; // r6
  ...
  if ( (unsigned int)v3 > v4 )
    return (std::__ndk1 *)sub_15F5B4(v2, v3);
  if ( (unsigned int)v3 < v4 )
  {
    result = (std::__ndk1 *)ceilf((float)*((unsigned int *)v2 + 3) / *((float *)v2 + 4));
    if ( v4 < 3
      || (v5 = (16843009
              * ((((v4 - ((v4 >> 1) & 0x55555555)) & 0x33333333)
                + (((v4 - ((v4 >> 1) & 0x55555555)) >> 2) & 0x33333333)
                + ((((v4 - ((v4 >> 1) & 0x55555555)) & 0x33333333)
                  + (((v4 - ((v4 >> 1) & 0x55555555)) >> 2) & 0x33333333)) >> 4)) & 0xF0F0F0F)) >> 24,
          v5 > 1) )
    {
    ...
    {
      v6 = 32 - __clz((unsigned int)result - 1);
      if ( (unsigned int)result >= 2 )
        result = (std::__ndk1 *)(1 << v6);
    }
    if ( v3 < result )
      v3 = result;
    if ( (unsigned int)v3 < v4 )
