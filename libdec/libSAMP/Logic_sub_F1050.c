// ADDR: 0xf1310
// SYMBOL: sub_F1310
int __fastcall sub_F1310(int a1)
{
  *(_DWORD *)(a1 + 8) = 0;
  *(_QWORD *)a1 = (unsigned int)&off_22AABC;
  sub_10B928(a1 + 12);
  return a1;
}
...
// ADDR: 0xf139e
// SYMBOL: sub_F139E
std::__shared_weak_count *__fastcall sub_F139E(std::__shared_weak_count *result, _DWORD *a2, int a3)
{
