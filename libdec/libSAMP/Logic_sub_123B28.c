// ADDR: 0x1238d0
// SYMBOL: sub_1238D0
_DWORD *__fastcall sub_1238D0(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  *a1 = 0;
  sub_123A68(v10, sub_1239DC, 0, a1);
  v3 = sub_123C34(v12, v10);
  sub_123BDC(v3);
  v4 = dword_263BF0;
  if ( !dword_263BF0 )
  {
    v5 = sub_123C34(v14, v12);
    sub_123BDC(v5);
    sub_123C60(&unk_263BE0, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6739664, sub_123BB0, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
