// ADDR: 0x121ba8
// SYMBOL: sub_121BA8
int __fastcall sub_121BA8(int a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  sub_121CFC(v10, sub_121CB0, 0, a1);
  v3 = sub_12347C(v12, v10);
  sub_123424(v3);
  v4 = dword_263BC8;
  if ( !dword_263BC8 )
  {
    v5 = sub_12347C(v14, v12);
    sub_123424(v5);
    sub_1234A8(&unk_263BB8, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6758648, sub_1233F8, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
