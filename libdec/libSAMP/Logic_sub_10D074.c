// ADDR: 0x10cec0
// SYMBOL: sub_10CEC0
_DWORD *__fastcall sub_10CEC0(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  *a1 = 0;
  sub_10CFEE(v10, sub_10CFCC, 0, a1);
  v3 = sub_10D180(v12, v10);
  sub_10D128(v3);
  v4 = dword_263240;
  if ( !dword_263240 )
  {
    v5 = sub_10D180(v14, v12);
    sub_10D128(v5);
    sub_10D1AC(&unk_263230, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6766612, sub_10D0FC, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
