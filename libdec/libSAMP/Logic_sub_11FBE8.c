// ADDR: 0x11fd44
// SYMBOL: sub_11FD44
int __fastcall sub_11FD44(const char *a1, int a2)
{
  size_t v4; // r2

  v4 = strlen(a1);
  return sub_1200F0(2, a1, v4, a2);
}
...
// ADDR: 0x1200f0
// SYMBOL: sub_1200F0
int __fastcall sub_1200F0(int a1, void *a2, int a3, int a4)
{
  int *v8; // r4
  int v9; // r2
  int v10; // r0
...
// ADDR: 0x163db0
// SYMBOL: sub_163DB0
int __fastcall sub_163DB0(int a1)
{
  return *(_DWORD *)(a1 + 8);
}
