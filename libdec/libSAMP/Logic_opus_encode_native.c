// ADDR: 0x1a5664
// SYMBOL: sub_1A5664
int __fastcall sub_1A5664(_DWORD *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  int v10; // r4
  int v11; // r6
  int v12; // r0
  ...
  {
    v13 = a1[40];
    v14 = sub_220A40(24 * a1[36], v43 * v44);
    v15 = sub_220A40(3 * v13, v14);
    if ( v15 < a6 )
      v11 = v15;
  }
  v16 = sub_220A40(v11 - v10, v43);
  v17 = v16 + 1;
  if ( v16 > 1275 )
    v17 = 1276;
  v18 = (char *)&v34 - ((v17 * v43 + 7) & 0xFFFFFFF8);
  v42 = &v34 - 76;
  j_opus_repacketizer_init(&v34 - 76);
  v19 = a1[17];
  v37 = a1[30];
  v35 = a1[32];
  v36 = a1[34];
...
// ADDR: 0x1a58d8
// SYMBOL: sub_1A58D8
int __fastcall sub_1A58D8(__int16 *a1, _WORD *a2, __int16 a3, __int16 a4, int a5, int a6, int a7, __int16 *a8, int a9)
{
  int v11; // r6
  int result; // r0
  _WORD *v14; // r2
  ...
  v11 = sub_220A40(48000, a9);
  result = sub_220A40(a5, v11);
  if ( a7 == 1 )
  {
    if ( result >= 1 )
    {
