        ...
        _DWORD *a11)
{
  ...
  if ( a5 == 2 && a10 != 0 )
    v18 = -2;
  v19 = *a6;
  v20 = sub_220A40(*a6 + v17 * (v18 + 2 * a5), v18 + 2 * a5);
  if ( v19 - v16 - 32 < v20 )
    v20 = v19 - v16 - 32;
  if ( v20 >= 64 )
    v20 = 64;
  v21 = a1[7];
  if ( v20 >= 4 )
    v22 = ((*((__int16 *)sub_19E8EC + (v20 & 7)) >> (14 - ((unsigned int)v20 >> 3))) + 1) & 0xFFFFFFFE;
  else
    v22 = 1;
  v23 = v22;
  if ( a10 )
...
LABEL_80:
          ...
          if ( !v75 )
          {
            if ( v23 > v74 )
            {
              sub_19E8FC(*(_DWORD *)(v94 + 8), a3, a4, v93, v97, a5);
              v39 = a2;
              v37 = 0;
              v28 = a7;
              v36 = a6;
...
LABEL_98:
      ...
      if ( v32 )
      {
        ...
        if ( v24 > 0x2000 )
          v33 = 0x7FFF;
        v34 = sub_220A40(v33, v23) + v24 * v23;
        v35 = 0;
        v31 = a10;
        if ( v34 >> 14 > 0 )
          v35 = v34 >> 14;
