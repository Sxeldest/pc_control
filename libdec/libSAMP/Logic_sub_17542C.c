// ADDR: 0x1751ce
// SYMBOL: sub_1751CE
int __fastcall sub_1751CE(int a1, const void **src)
{
  int v4; // r0
  int v5; // r1
  int v6; // r3
  ...
  *(_DWORD *)(a1 + 76) = v18 + 1;
  ...
  v21 = v20 + 112;
  if ( !*(_DWORD *)(v20 + 112) )
    *(_DWORD *)v21 = *(_DWORD *)(*(_DWORD *)(a1 + 60) + 4 * *(_DWORD *)(a1 + 52) - 4);
  v23 = *(unsigned __int8 *)(v20 + 8);
  v22 = (_BYTE *)(v20 + 8);
  if ( !v23 )
  {
    v24 = (_DWORD *)(v19 + 116 * v18);
    v25 = (void *)sub_1654B0(v24[1]);
    v26 = v24[1];
    *v22 = 1;
    *v24 = v25;
