// ADDR: 0x11cd34
// SYMBOL: sub_11CD34
_DWORD *__fastcall sub_11CD34(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  *a1 = 0;
  sub_11CEB4(v10, sub_11CE40, 0, a1);
  v3 = sub_11D048(v12, v10);
  sub_11CFF0(v3);
  v4 = dword_2637A0;
  if ( !dword_2637A0 )
  {
    v5 = sub_11D048(v14, v12);
    sub_11CFF0(v5);
    sub_11D074(&unk_263790, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6754220, sub_11CFC4, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
