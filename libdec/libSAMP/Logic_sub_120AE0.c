// ADDR: 0x120860
// SYMBOL: sub_120860
int __fastcall sub_120860(int a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  sub_120A04(v10, sub_120968, 0, a1);
  v3 = sub_120C08(v12, v10);
  sub_120BB0(v3);
  v4 = dword_263928;
  if ( !dword_263928 )
  {
    v5 = sub_120C08(v14, v12);
    sub_120BB0(v5);
    sub_120C34(&unk_263918, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6759240, sub_120B68, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
