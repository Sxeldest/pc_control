...
// ADDR: 0x21e548
// SYMBOL: sub_21E548
int __fastcall sub_21E548(int a1, char a2, int a3, void *a4, int a5)
{
  int v9; // r11
  int v10; // r0
  int v11; // r0
...
LABEL_7:
    ...
    *(_DWORD *)(a1 + 12) = v11;
    v49 = a2;
    v54 = sub_21E818(a5, 15);
    v13 = sub_222B44(a5);
    v14 = *v12;
    v15 = v13;
    v59[0] = v12 + 1;
    v16 = sub_21EA18(v59, v14);
    v17 = ~v15;
...
LABEL_59:
        sub_21E854(v52, v48);
      v26 = sub_21EA18(&v58, v22);
      v27 = sub_21EA18(&v58, v22);
      v28 = sub_21EA18(&v58, v22);
      v29 = sub_21EABC(&v58);
      v30 = v26 >= v23;
      if ( v26 <= v23 )
        v30 = v23 >= v27 + v26;
...
LABEL_61:
                ...
                v39 = v37;
                if ( sub_21EAE0(v33, v33 >> 31, v53, v38, v37, v48) )
                {
                  if ( v9 )
                  {
                    v50[4] = v47;
...
// ADDR: 0x21e818
// SYMBOL: sub_21E818
int __fastcall sub_21E818(int a1, int a2)
{
  int v3; // [sp+8h] [bp-8h] BYREF

  sub_221D60(a1, 0, a2, 0, &v3);
  return v3;
}
...
// ADDR: 0x21e854
// SYMBOL: sub_21E854
void __fastcall __noreturn sub_21E854(int a1, void *a2)
{
  j___cxa_begin_catch(a2);
  if ( a1 )
    sub_21E258(*((void (**)(void))a2 - 5));
  std::terminate();
}
...
// ADDR: 0x21e870
// SYMBOL: sub_21E870
int __fastcall sub_21E870(int a1, int a2, _DWORD *a3)
{
  int v5; // r5
  int v6; // r2
  ...
  sub_21EBB0(a2, 1, *a3);
  v5 = a3[4];
  v6 = sub_21E818(a2, 15) & 1 | v5;
  return sub_21EBB0(a2, 15, v6);
}
