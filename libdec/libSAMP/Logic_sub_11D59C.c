// ADDR: 0x11d3b8
// SYMBOL: sub_11D3B8
_DWORD *__fastcall sub_11D3B8(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  *a1 = 0;
  a1[1] = 0;
  sub_11D502(v10, sub_11D4C4, 0, a1);
  v3 = sub_11D6C0(v12, v10);
  sub_11D668(v3);
  v4 = dword_2637C8;
  if ( !dword_2637C8 )
  {
    v5 = sub_11D6C0(v14, v12);
    sub_11D668(v5);
    sub_11D6EC(&unk_2637B8, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6771880, sub_11D624, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
