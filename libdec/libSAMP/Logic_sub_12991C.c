// ADDR: 0x129650
// SYMBOL: sub_129650
_DWORD *__fastcall sub_129650(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  *a1 = 0;
  sub_12980C(v10, sub_129758, 0, a1);
  v3 = sub_10CD74((int)v12, (int)v10);
  sub_1299C8(v3);
  v4 = dword_314178;
  if ( !dword_314178 )
  {
    v5 = sub_10CD74((int)v14, (int)v12);
    sub_1299C8(v5);
    sub_10CDA0(dword_314168, (int)v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6767232, sub_1299A4, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
