// ADDR: 0x11e040
// SYMBOL: sub_11E040
_DWORD *__fastcall sub_11E040(_DWORD *a1)
{
  int v2; // r10
  int v3; // r0
  int v4; // r6
  ...
  v2 = dword_23DF24;
  *a1 = 0;
  sub_11E176(v10, sub_11E14C, 0, a1);
  v3 = sub_11E314(v12, v10);
  sub_11E2BC(v3);
  v4 = dword_263818;
  if ( !dword_263818 )
  {
    v5 = sub_11E314(v14, v12);
    sub_11E2BC(v5);
    sub_11E340(&unk_263808, v14);
    if ( v14 == v15 )
    {
      v6 = 4;
    }
...
LABEL_12:
  if ( !v4 )
    sub_164196(v2 + 6751980, sub_11E284, a1);
  if ( v10 == v11 )
  {
    v8 = 4;
    goto LABEL_18;
