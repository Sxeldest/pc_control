    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isGenerateWineprefix()) {
            ...
            if (shortcut != null) {
                ...
                String enableXInput = shortcut.getExtra("enableXInput");
                if (!enableXInput.isEmpty()) winHandler.setEnableXInput(enableXInput.equals("1"));

                String enableDInput = shortcut.getExtra("enableDInput");
                if (!enableDInput.isEmpty()) winHandler.setEnableDInput(enableDInput.equals("1"));
            }
            else {
                winHandler.setDInputMapperType(container.getDInputMapperType());
                winHandler.setEnableXInput(container.isEnableXInput());
                winHandler.setEnableDInput(container.isEnableDInput());
            }
