...
public class ControlsEditorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showControlElementSettings(View anchorView) {
        ...
        final Runnable updateLayout = () -> {
            ...
            view.findViewById(R.id.CBLock8Way).setVisibility(View.GONE);
            ...
            else if (type == ControlElement.Type.STICK) {
                view.findViewById(R.id.CBLock8Way).setVisibility(View.VISIBLE);
            }
        ...
        CheckBox cbLock8Way = view.findViewById(R.id.CBLock8Way);
        cbLock8Way.setChecked(element.isLock8Way());
        cbLock8Way.setOnCheckedChangeListener((buttonView, isChecked) -> {
            element.setLock8Way(isChecked);
            profile.save();
            inputControlsView.invalidate();
        });
