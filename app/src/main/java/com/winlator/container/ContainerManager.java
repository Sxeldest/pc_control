...
public class ContainerManager {
    ...
    private void duplicateContainer(Container srcContainer) {
        ...
        dstContainer.setEnableXInput(srcContainer.isEnableXInput());
        dstContainer.setEnableDInput(srcContainer.isEnableDInput());
        dstContainer.setDInputMapperType(srcContainer.getDInputMapperType());
