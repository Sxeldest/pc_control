...
public class Container {
    ...
    private boolean enableXInput = true;
    private boolean enableDInput = true;
    private byte dinputMapperType = 0;
    ...
    public boolean isEnableXInput() {
        return enableXInput;
    }

    public void setEnableXInput(boolean enableXInput) {
        this.enableXInput = enableXInput;
    }
        ...
        for (Iterator<String> it = data.keys(); it.hasNext(); ) {
            ...
            switch (key) {
                ...
                case "wow64Mode" :
                    ...
                    break;
                case "enableXInput" :
                    setEnableXInput(data.getBoolean(key));
                    break;
                case "enableDInput" :
                    setEnableDInput(data.getBoolean(key));
                    break;
